            ...
            <div class="contact-page-content">
                ...
                <div class="contact-form clearfix">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <p class="full-row {{ $errors->has('year') ? ' has-error' : '' }}">
                                <span class="contact-label">
                                    <label for="name-id">Year:</label>
                                    <span class="small-text">Year of Graduation</span>
                                </span>
                            <input type="number" id="year-id" name="year" value="{!! old('year') !!}">
                            @if ($errors->has('year'))
                                <span class="invalid-feedback">
                                    <br/><strong class="text-danger">{{ $errors->first('year') }}</strong>
                                </span>
                            @endif
                        </p>

                        <p class="full-row {{ $errors->has('degree') ? ' has-error' : '' }}">
                                <span class="contact-label">
                                    <label for="name-id">degree:</label>
                                    <span class="small-text">Type Your Degree Name</span>
                                </span>
                            <input type="text" id="name-id" name="degree" value="{!! old('degree') !!}">
                            @if ($errors->has('degree'))
                                <span class="invalid-feedback">
                                    <br/><strong class="text-danger">{{ $errors->first('degree') }}</strong>
                                </span>
                            @endif
                        </p>
