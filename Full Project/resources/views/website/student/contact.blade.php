        ...
        <div class="col-md-12">
            <div class="contact-page-content">
                <div class="contact-heading">
                    <h3>Student Contact as <span class="text-primary">{!! $student->first_name. ' '.$student->last_name !!}</span></h3>
                </div>
                ...
                <div class="contact-form clearfix">
                    <form method="post" action="{!! url('alumni/contact/store') !!}">
                        @csrf
                        <input type="hidden" name="alumni_or_student" value="{!! (isset($student->user_name))? $student->user_name:'' !!}">
