    ...
    <div class="row">
        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('current_affiliation.store') }}" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group {{ $errors->has('job_status') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="job_status" class="form-control" value="{!! old('job_status') !!}" placeholder="Enter your job status">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="name" class="form-control" value="{!! old('name') !!}" placeholder="Enter your company and organization name">
                                @if ($errors->has('name'))
                                    <span class="help-block">
                                        {{ $errors->first('name') }}
                                    </span>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group {{ $errors->has('designation') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="designation" class="form-control" value="{!! old('designation') !!}" placeholder="Enter your job designation">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group {{ $errors->has('duration_form') ? ' has-error' : '' }}">
                                ...
                                <input type="date" name="duration_form" class="form-control" value="{!! old('duration_form') !!}">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group {{ $errors->has('duration_to') ? ' has-error' : '' }}">
                                ...
                                <input type="date" name="duration_to" class="form-control" value="{!! old('duration_to') !!}">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group {{ $errors->has('current_status') ? ' has-error' : '' }}">
                                ...
                                <input type="checkbox" name="currently_working" value="Continuing" class="checkbox">
                            </div>
                        </div>
                    </div>
