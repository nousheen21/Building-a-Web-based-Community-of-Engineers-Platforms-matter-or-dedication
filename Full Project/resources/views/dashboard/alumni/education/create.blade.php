                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group {{ $errors->has('degree') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="degree" class="form-control" value="{!! old('degree') !!}" placeholder="Exam/Degree Title">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group {{ $errors->has('institute') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="institute" class="form-control" value="{!! old('institute') !!}" placeholder="School/College/Institute/University Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group {{ $errors->has('group') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="group" class="form-control" value="{!! old('group') !!}" placeholder="Concentration/ Major/Group">
                                @if ($errors->has('group'))
                                    <span class="help-block">
                                        {{ $errors->first('group') }}
                                    </span>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group {{ $errors->has('result') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="result" class="form-control" value="{!! old('result') !!}" placeholder="Final Resutl">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group {{ $errors->has('scale') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="scale" class="form-control" value="{!! old('scale') !!}" placeholder="Out of Scale">
                                @if ($errors->has('scale'))
                                    <span class="help-block">
                                        {{ $errors->first('scale') }}
                                    </span>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group {{ $errors->has('duration') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="duration" class="form-control" value="{!! old('duration') !!}" placeholder="Duration of (Year)">
