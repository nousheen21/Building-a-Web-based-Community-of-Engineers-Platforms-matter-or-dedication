    ...
    <div class="row">
        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <form action="{!! url('/alumni/update', $user->id) !!}" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="col-sm-4">
                        ...
                        <div class="col-sm-3">
                            <div class="col-sm-12">
                                <div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                                    ...
                                    <img src="{!! asset('image/user/'.$user->image) !!}" class="img-thumbnail img-circle"
                                         width="100%"><br>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group {{ $errors->has('cover_image') ? ' has-error' : '' }}">
                                    ...
                                    <img src="{!! asset('image/user/'.$user->cover_image) !!}" class="img-thumbnail" width="100%"><br>
